...
class SF_SSDVGG(SFVGG, BaseModule):
    ...
    Example:
        >>> self = SF_SSDVGG(input_size=300, depth=11)
        >>> self.eval()
    ...
    def init_weights(self, pretrained=None):
        super(SF_SSDVGG, self).init_weights()
