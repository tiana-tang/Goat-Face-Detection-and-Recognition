...
class DETRHead(AnchorFreeHead):
    ...
    def forward_tuning(self,
        ...
        # 计算tuning模型的loss
        tuning_results_list = self.get_bboxes(*outs, img_metas)
        tuning_bbox_results = [
        ...
        losses = self.loss(*loss_inputs, gt_bboxes_ignore=gt_bboxes_ignore)
        losses['loss_cls'] *= reward_loss.detach()
        losses['loss_bbox']*= reward_loss.detach()
        # losses = reward_loss*losses
        return losses
